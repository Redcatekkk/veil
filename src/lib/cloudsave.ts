...
export function cloudSavesEnable(
  steamPath: string,
  folder: string
): Promise<CloudSavesStatus> {
...
export function cloudSavesSetFolder(
  steamPath: string,
  folder: string
): Promise<CloudSavesStatus> {
...
export function cloudSavesSetLogging(
  steamPath: string,
  enabled: boolean
): Promise<CloudSavesStatus> {
...
export function cloudSavesImport(
  steamPath: string,
  zipPath: string
): Promise<number> {
